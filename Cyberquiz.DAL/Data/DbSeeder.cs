...
namespace Cyberquiz.DAL.Data
{
    public static class DbSeeder
    {
        public static async Task SeedAsync(AppDbContext context)
        {
            ...
            // Geografi
            var quizEuropa = new QuizModel
            {
                Name = "Europa",
                Description = "Huvudstäder och länder i Europa.",
                SubCategory = subEuropa,
                Questions = new List<QuestionModel> { qFrankrikesHuvudstad, qSverigesHuvudstad, qFlestInvanareEuropa }
            };
            var quizVarlden = new QuizModel
            {
                Name = "Världsgeografi",
                Description = "Världens länder, floder och landmärken.",
                SubCategory = subVarlden,
                Questions = new List<QuestionModel> { qStorstaLandYta, qLangstaFlod }
            };
            var quizSkandinavien = new QuizModel
            {
                Name = "Skandinavien",
                Description = "Norden — Sverige, Norge och Danmark.",
                SubCategory = subSkandinavien,
                Questions = new List<QuestionModel> { qNorgesHuvudstad, qDanmarksHuvudstad }
            };

            // Historia
            var quizAntiken = new QuizModel
            {
                Name = "Antiken",
                Description = "Antikens Grekland och Rom.",
                SubCategory = subAntiken,
                Questions = new List<QuestionModel> { qAntikRomLand, qVastromerriketFall }
            };
            var quizModernHistoria = new QuizModel
            {
                Name = "Modern historia",
                Description = "Historiska händelser under 1900-talet.",
                SubCategory = subModernHistoria,
                Questions = new List<QuestionModel> { qAndraVK, qStoraNordiskaKriget }
            };
            var quizMedeltiden = new QuizModel
            {
                Name = "Medeltiden",
                Description = "Europa under medeltiden.",
                SubCategory = subMedeltiden,
                Questions = new List<QuestionModel> { qMagnaCarta, qKonstantinopel }
            };

            // Vetenskap
            var quizKemi = new QuizModel
            {
                Name = "Kemi",
                Description = "Grundämnen och kemiska formler.",
                SubCategory = subKemi,
                Questions = new List<QuestionModel> { qVattenFormel, qAtomNummer1 }
            };
            var quizFysik = new QuizModel
            {
                Name = "Fysik",
                Description = "Ljus, kraft och universums lagar.",
                SubCategory = subFysik,
                Questions = new List<QuestionModel> { qLjusets, qGravitationslagen }
            };
            var quizBiologi = new QuizModel
            {
                Name = "Biologi",
                Description = "Celler, kromosomer och levande organismer.",
                SubCategory = subBiologi,
                Questions = new List<QuestionModel> { qKromosompar, qMinstaEnhet }
            };

            // Sport
            var quizFotboll = new QuizModel
            {
                Name = "Fotboll",
                Description = "VM, regler och fotbollshistoria.",
                SubCategory = subFotboll,
                Questions = new List<QuestionModel> { qFotbollsspelare, qVMGuldFotboll }
            };
            var quizOS = new QuizModel
            {
                Name = "Olympiska spelen",
                Description = "Historik och fakta om OS.",
                SubCategory = subOS,
                Questions = new List<QuestionModel> { qForstaModernaOS, qOSIntervall }
            };
            var quizTennis = new QuizModel
            {
                Name = "Tennis",
                Description = "Grand Slam och tennisregler.",
                SubCategory = subTennis,
                Questions = new List<QuestionModel> { qTennisNollPoang, qTennisGrus }
            };

            // Musik
            var quizKlassisk = new QuizModel
            {
                Name = "Klassisk musik",
                Description = "Kompositörer och klassiska verk.",
                SubCategory = subKlassisk,
                Questions = new List<QuestionModel> { qFurElise, qGitarrStrangar }
            };
            var quizPopRock = new QuizModel
            {
                Name = "Pop & Rock",
                Description = "Populärmusikens stora namn.",
                SubCategory = subPopRock,
                Questions = new List<QuestionModel> { qBohemianRhapsody, qABBA }
            };
            var quizJazz = new QuizModel
            {
                Name = "Jazz",
                Description = "Jazzens historia och instrument.",
                SubCategory = subJazz,
                Questions = new List<QuestionModel> { qJazzUrsprung, qMilesDavis }
            };

            // Film & TV
            var quizHollywood = new QuizModel
            {
                Name = "Hollywood",
                Description = "Stora filmer och skådespelare.",
                SubCategory = subHollywood,
                Questions = new List<QuestionModel> { qIronMan, qTitanicAr }
            };
            var quizAnimation = new QuizModel
            {
                Name = "Animationsfilmer",
                Description = "Världens bästa tecknade filmer.",
                SubCategory = subAnimation,
                Questions = new List<QuestionModel> { qSpiritedAway, qLejonkungen }
            };
            var quizSerier = new QuizModel
            {
                Name = "TV-serier",
                Description = "Populära serier från hela världen.",
                SubCategory = subSerier,
                Questions = new List<QuestionModel> { qGameOfThrones, qSquidGame }
            };

            // Matematik
            var quizAritmetik = new QuizModel
            {
                Name = "Aritmetik",
                Description = "Räkning och talteori.",
                SubCategory = subAritmetik,
                Questions = new List<QuestionModel> { qKvadratrot144, qHexagonSidor }
            };
            var quizGeometri = new QuizModel
            {
                Name = "Geometri",
                Description = "Vinklar, former och pi.",
                SubCategory = subGeometri,
                Questions = new List<QuestionModel> { qRatVinkel, qPi }
            };
            var quizAlgebra = new QuizModel
            {
                Name = "Algebra",
                Description = "Ekvationer och okända variabler.",
                SubCategory = subAlgebra,
                Questions = new List<QuestionModel> { qAlgebra2x, qAndragradsekvation }
            };

            // Natur
            var quizDjur = new QuizModel
            {
                Name = "Djur",
                Description = "Djurrikets stora och små.",
                SubCategory = subDjur,
                Questions = new List<QuestionModel> { qStorstaLanddjur, qInsektBen }
            };
            var quizVaxter = new QuizModel
            {
                Name = "Växter",
                Description = "Träd, växter och fotosyntes.",
                SubCategory = subVaxter,
                Questions = new List<QuestionModel> { qEkollon, qFotosyntes }
            };
            var quizHav = new QuizModel
            {
                Name = "Hav & Oceaner",
                Description = "Världshaven och dess hemligheter.",
                SubCategory = subHav,
                Questions = new List<QuestionModel> { qStorstaOcean, qJordensVatten }
            };

            // Teknik
            var quizDatorer = new QuizModel
            {
                Name = "Datorer",
                Description = "Hårdvara, mjukvara och operativsystem.",
                SubCategory = subDatorer,
                Questions = new List<QuestionModel> { qCPU, qWindowsSkapare }
            };
            var quizInternet = new QuizModel
            {
                Name = "Internet",
                Description = "Webben och stora internettjänster.",
                SubCategory = subInternet,
                Questions = new List<QuestionModel> { qWWW, qGoogleGrundat }
            };
            var quizMobil = new QuizModel
            {
                Name = "Mobil & Appar",
                Description = "Smartphones och mobilutveckling.",
                SubCategory = subMobil,
                Questions = new List<QuestionModel> { qFoerstaIphone, qIphoneTillverkare }
            };

            // Mat & Dryck
            var quizMatlagning = new QuizModel
            {
                Name = "Matlagning",
                Description = "Rätter och råvaror från hela världen.",
                SubCategory = subMatlagning,
                Questions = new List<QuestionModel> { qSushiUrsprung, qGuacamoleIngrediens }
            };
            var quizDrycker = new QuizModel
            {
                Name = "Drycker",
                Description = "Vin, kaffe och andra drycker.",
                SubCategory = subDrycker,
                Questions = new List<QuestionModel> { qKaffeProducent, qVinIngredienser }
            };
            var quizBakning = new QuizModel
            {
                Name = "Bakning",
                Description = "Ingredienser och tekniker för bakning.",
                SubCategory = subBakning,
                Questions = new List<QuestionModel> { qBrodJaesning, qBakpulver }
            };
            ...
            context.Quizzes.AddRange(
                quizEuropa, quizVarlden, quizSkandinavien,
                quizAntiken, quizModernHistoria, quizMedeltiden,
                quizKemi, quizFysik, quizBiologi,
                quizFotboll, quizOS, quizTennis,
                quizKlassisk, quizPopRock, quizJazz,
                quizHollywood, quizAnimation, quizSerier,
                quizAritmetik, quizGeometri, quizAlgebra,
                quizDjur, quizVaxter, quizHav,
                quizDatorer, quizInternet, quizMobil,
                quizMatlagning, quizDrycker, quizBakning,
                quizAllmanbildning
            );
